...
import { runCrawlerCheck, runDomainAgeCheck, runMetaCheck, runSchemaCheck } from "@/server/actions/tools";
...
type Slug = "ai-crawler-checker" | "schema-markup-checker" | "meta-tag-checker" | "domain-age-checker";
